function [y_next] = trbdf2(func, dt, t_val, X_vec, args)
    ...
    F1 = @(y_i_gamma) y_i_gamma - ( y + (gamma * h / 2) * ( func(t_val, y, args{:}) + func(t_intermediate, y_i_gamma, args{:}) ) );
    ...
    if exitflag <= 0 % exitflag < 1 typically means no convergence
        warning('trbdf2:fsolveNoConvergence', ...
    ...
    F2 = @(y_ip1) y_ip1 - (1/(2-gamma)) * ( (1/gamma)*y_intermediate - ((1-gamma)^2/gamma)*y + (1-gamma)*h*func(t_val + h, y_ip1, args{:}) );
